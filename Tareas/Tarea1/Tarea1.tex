...
\begin{thebibliography}{99}
  \bibitem{bl}{R (lenguaje de programación). (n.d.). Wikipedia. Retrieved
    October 1, 2021, from
    \url{https://es.wikipedia.org/wiki/R_(lenguaje_de_programaci%C3%B3n)}}
  \bibitem{bl}{A. (2021). Statements and the structure of a program. Learncpp.
    \url{https://www.learncpp.com/cpp-tutorial/statements-and-the-structure-of-a-program/}}
  \bibitem{bl}{rust-unoficcial. (2021). Constructors. Rust Design Patterns.
    \url{https://rust-unofficial.github.io/patterns/idioms/ctor.html}}
  \bibitem{bl}{The Rust Programming Language - The Rust Programming Language.
    (2018). The Rust Programming Language.
    \url{https://doc.rust-lang.org/stable/book/}}
  \bibitem{bl}{Ramirez, K. (2021, septiembre). Nota de clase 1. Conceptos
    generales.}
  \bibitem{bl}{Swift (lenguaje de programación). (2021, June 6). Wikipedia.
    \url{https://es.wikipedia.org/wiki/Swift_(lenguaje_de_programaci%C3%B3n)}}
  \bibitem{bl}{Tutorial: Enlace de una biblioteca Swift de iOS. (2020, February
    11). Microsoft.
    \url{https://docs.microsoft.com/es-es/xamarin/ios/platform/binding-swift/walkthrough}}
  \bibitem{bl}{Tipos de biblioteca estándar en Swift: NO PRIMATIVOS. (n.d.).
    ICHI.PRO. Retrieved October 1, 2021, from
    \url{https://ichi.pro/es/tipos-de-biblioteca-estandar-en-swift-no-primativos-224372004350148}}
  \bibitem{bl}{Santana, A., \& Nieves Hernández, C. (n.d.). Librerías en R.
    ULPGC. Retrieved October 1, 2021, from
    \url{https://estadistica-dma.ulpgc.es/cursoR4ULPGC/5-librerias.html#a%C3%B1adir_paquetes_a_nuestra_instalaci%C3%B3n_de_r}}
  \bibitem{bl}{Capítulo 5 Manejo de la biblioteca y gestión de paquetes. (n.d.).
    \url{https://Bookdown.Org.}Retrieved October 1, 2021, from
    \url{https://bookdown.org/gboccardo/manual-ED-UCH/manejo-de-la-biblioteca-y-gestion-de-paquetes.html#descargar-paquetes}}
\end{thebibliography}
\end{document}
